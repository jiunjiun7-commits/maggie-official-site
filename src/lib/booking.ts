...
export const INTENTS = [
  { key: "buy", label: "買房 / 換屋", hint: "預算、區域、房型" },
  { key: "sell", label: "賣房 / 委託", hint: "屋況、售價、時間" },
  { key: "invest", label: "資產配置", hint: "置產、收租、現金流" },
  { key: "tax", label: "稅務諮詢", hint: "房地合一、重購退稅" },
  { key: "price", label: "行情諮詢", hint: "想先了解區域行情" }
] as const;
...
export const MEET_TYPES = [
  { key: "office", label: "門市面談", description: "永義房屋 農十六大千加盟店" },
  { key: "phone", label: "電話聯繫", description: "由 Maggie 主動致電" },

    ...
    <div className="site-shell">
      ...
      <main className="card-page">
        <article className="business-card">
          <div className="card-cover">{BRAND.shortName} · {PROFILE.alias}</div>
          ...
          <div className="card-copy">
            ...
            {PROFILE.slogan ? <p className="card-slogan">{PROFILE.slogan}</p> : null}
          </div>
          ...
          <div className="contact-list">
            ...
            <ContactRow symbol="A" value={BRAND.areas} />
          </div>
